"""
Встроенный список источников (URLs).
Вынесен из pipeline.py для удобства обновления.
"""

from typing import List

# Встроенный список источников (237+ URLs)
BUILTIN_URLS: List[str] = [
